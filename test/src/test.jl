...
@testset "BTC Tests" begin
    @test getblockhash(BTC, 0) == "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"
    ...
    @test getbalancehistory(BTC, "12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX") != 0
...
@testset "BCH Tests" begin
    @test getblockhash(BCH, 0) == "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"
    ...
    @test getbalancehistory(BCH, "12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX") != 0
...
@testset "LTC Tests" begin
    @test getblockhash(LTC, 0) == "12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"
    ...
    @test getbalancehistory(LTC,"LSdTvMHRm8sScqwCi6x9wzYQae8JeZhx6y") != 0
end
#################### YEC Tests ######################
@testset "YEC Tests" begin
    @test getblockhash(YEC, 570000) == "0000014fbc5917ba8bcacf3336faf588d86b32443aa3a490a587af5750c77ec5"
    ...
    @test getbalancehistory(YEC, "s2xbtsG1JXb4pu3H2ZuhuL8UTFvtmSizYRL") != 0
